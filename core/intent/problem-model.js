...
const DOMAIN_RULES=[
  ['software',/(?:\bkoodi\w*|\bcode\b|repo\w*|vercel|css\b|javascript|typescript|node\b|api\b|bugi\w*|debug|testi\w*|arkkitehtuur\w*|(?:^|[\s`'"(])[A-Za-z0-9._@+-]+(?:\/[A-Za-z0-9._@+-]+)+\.(?:js|mjs|cjs|ts|tsx|jsx|json|css|html|sh)\b)/i],

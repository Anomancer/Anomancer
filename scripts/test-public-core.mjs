...
test('Core Registry on 15.4 ja agentteja on edelleen kahdeksan',()=>{assert.equal(CORE_VERSION,'15.4.0');assert.equal(AGENT_REGISTRY.length,8);assert.equal(ORCHESTRA_REGISTRY.length,1);});

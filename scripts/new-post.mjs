...
let category=await q('Kategoria','field'); if(!cats.includes(category)) category='field';
...
fs.writeFileSync(file,fm);console.log(`✓ Luotu ${path.relative(process.cwd(),file)}`);console.log('Kun valmis: npm run build && npx vercel --prod');

...
fs.writeFileSync(file,fm);console.log(`✓ Luotu ${path.relative(process.cwd(),file)}`);console.log('Kun valmis: npm run deploy:prod → tarkistusportti ja suora Vercel-tuotantodeploy.');

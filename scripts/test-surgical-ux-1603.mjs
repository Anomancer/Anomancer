...
test('private Core käyttää mobiilitimelinea kaikilla askelmäärillä',()=>{const css=readAdminCss();assert.match(css,/orchestra-stages::before/);assert.match(css,/orchestra-stages \.orchestra-step::before/);assert.match(css,/orchestra-stages \.orchestra-step::after\{display:none\}/);assert.doesNotMatch(css,/orchestra-stages\[data-step-count=\"8\"\]/)});

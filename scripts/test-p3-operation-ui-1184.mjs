...
test('1.18.4 Package Spec ilmoittaa vain hyväksyntäportilliset sivuvaikutuskyvykkyydet',()=>{
  ...
  assert.equal(pkg.version,'1.18.4');assert.equal(manifest.version,'1.2.0');

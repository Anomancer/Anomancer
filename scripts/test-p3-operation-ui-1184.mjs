...
test('1.18.5 Package Spec ilmoittaa vain hyväksyntäportilliset sivuvaikutuskyvykkyydet',()=>{
  ...
  assert.equal(pkg.version,'1.18.5');assert.equal(manifest.version,'1.3.0');

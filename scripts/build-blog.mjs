...
const manifest={generatedAt:new Date().toISOString(),published:published.map(p=>({lang:p.lang,slug:p.slug,title:p.title,category:p.category,date:p.date,url:articleUrl(p),coverImage:p.coverImage||''}))};

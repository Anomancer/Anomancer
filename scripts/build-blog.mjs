...
function readPosts() {
  ...
  return posts.sort((a,b)=>Number(Boolean(b.pinned))-Number(Boolean(a.pinned)) || String(b.date).localeCompare(String(a.date)) || a.title.localeCompare(b.title));
}
function inline(md) {
  let s = esc(md);
  const code = [];

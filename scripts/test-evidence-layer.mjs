...
try{
  ...
  test('Markdown roundtrip säilyttää evidence-rakenteen',()=>{const md=serializePost(fixture);const p=parseMarkdown(md,'fixture');assert.equal(p.answer,fixture.answer);assert.deepEqual(p.sources,fixture.sources);assert.deepEqual(p.claims,fixture.claims);});

...
test('release metadata ja check-portti ovat 16.8.4',()=>{assert.equal(pkg.version,'1.17.2');assert.match(pkg.scripts.check,/test-evidence-interaction-1683/);assert.match(html,/1\.17\.1/);});

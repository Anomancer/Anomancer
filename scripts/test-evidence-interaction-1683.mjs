...
test('release metadata ja check-portti ovat 16.8.4',()=>{assert.equal(pkg.version,'1.18.5');assert.match(pkg.scripts.check,/test-evidence-interaction-1683/);assert.match(html,/id="systemCoreVersion">1\.18\.5/);});

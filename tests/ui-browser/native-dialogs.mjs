...
ok('ihmisen toimivaltarajat käyttävät async vahvistusta',()=>{
  ...
  for(const marker of ['Poista lähetys','Merkitse lähde tarkistetuksi','Arkistoi työtila','Poista arkisto-objekti','Poista orkesteri','Sovella orkesterin ehdotus'])assert.match(joined,new RegExp(marker));

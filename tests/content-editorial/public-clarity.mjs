...
test('julkinen Core säilyy vakaana Lighthouse-rakennushaarassa',()=>{assert.equal(pkg.version,'1.20.0-lighthouse-shell.1');assert.equal(publicCore.version,'1.18.7');});

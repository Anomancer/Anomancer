...
test('julkinen Core säilyy vakaana Lighthouse-rakennushaarassa',()=>{assert.equal(pkg.version,'1.21.0-lighthouse-hands.1');assert.equal(publicCore.version,'1.18.7');});

...
const baseArtifact={project:{name:'Capability gate'},code:[{path:'src/p3.js',language:'javascript',content:'export const capabilityGate = true;\n',notes:'P3 bounded operation'}],review:{decision:'approved'},release:{version:'1.18.7',check:'passing',humanApproval:'approved',notes:'P3 test'},architecture:[],tasks:[],tests:[],runs:[],documentation:[]};

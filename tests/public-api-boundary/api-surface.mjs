...
await test('Vercel API-pinta sisältää vakaat gatewayt ja kolme lukittua Lighthouse Lab -reittiä',()=>{
  assert.deepEqual(allJs('api'),['api/admin/auth.js','api/admin/content.js','api/admin/core.js','api/contact.js','api/lab/intent.js','api/lab/mutation.js','api/lab/preview.js']);

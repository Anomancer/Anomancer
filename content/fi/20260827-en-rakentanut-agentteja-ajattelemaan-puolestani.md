...
coverImage: ""
coverAlt: ""
answer: "Tarkastuksen jälkeen yksikään väite ei nouse supported-tasolle, koska kaikki lähteet ovat edelleen candidate-verifioituja. Empiiriset luvut ja tutkimusväitteet on merkitty interpretaatioiksi, ja järjestelmän omat kuvaukset ovat kirjoittajan ilmoittamia asioita ilman riippumatonta lähdettä. Suurimmat riskit liittyvät tarkkoihin prosenttilukuihin ja siihen, että oma arkkitehtuuri esitetään faktana. Näitä kannattaa pehmentää tai vahvistaa ennen julkaisua."
...
claims: [{"status":"interpretation","text":"Anomancerissa on yhdeksän agenttia, joilla ei ole julkaisuvaltaa; viimeinen hyväksyntä on ihmisellä.","evidence":[],"note":"Kirjoittajan oma järjestelmäkuvaus; mukana ei ole riippumatonta lähdettä."},{"status":"interpretation","text":"Kielimalli voi kirjoittaa väärän väitteen samalla itsevarmuudella kuin oikean.","evidence":[],"note":"ACL 2024 -paperi tukee suuntaa, mutta lähde on vasta ehdokas."},{"status":"interpretation","text":"Virheellisten vastausten osuus kielimallien luottavaisissa vastauksissa oli keskimäärin 47 prosenttia.","evidence":[],"note":"Tarkka luku nojaa candidate-lähteeseen; luku pitää varmistaa alkuperäisestä paperista."},{"status":"interpretation","text":"Ihminen jää helposti human-in-the-loop-järjestelmässä kumileimasimeksi.","evidence":[],"note":"Automation bias -katsaus vuodelta 2012; ei käsittele suoraan LLM-aikakautta."},{"status":"interpretation","text":"Kaupalliset AI-tekstintunnistimet eivät sovellu korkean panoksen konteksteihin; väärien positiivisten osuudet ovat 0,05–68,6 % ja väärien negatiivisten 0,3–99,6 %, ja pienikin muokkaus romahduttaa luotettavuuden.","evidence":[],"note":"Luvut ovat toistaiseksi candidate-lähteen varassa; varmistettava ennen julkaisua."},{"status":"interpretation","text":"Lähde-ehdokas ei ole todiste; hakutulos, URL tai tieteellisen näköinen PDF ei yksin riitä vahvistukseksi.","evidence":[],"note":"Kirjoittajan metodologinen periaate; ei suoraa empiiristä vahvistusta."},{"status":"interpretation","text":"Seitsemän tai yhdeksän tekoälyä ei tee totuutta; jos kaikki saavat saman virheellisen oletuksen, lopputulos voi olla hyvin organisoitua hölynpölyä.","evidence":[],"note":"Tulkinnallinen varoitus; ei suoraa lähdettä."},{"status":"interpretation","text":"Teksti muuttuu matkalla, joten väitteet pitää tarkastaa muokkaamisen jälkeen uudelleen; muuten voi tarkistaa yhden tekstin ja julkaista toisen.","evidence":[],"note":"Oma periaate; arXiv-ehdokas tukee ajatusta, mutta ei ole vahvistettu."},{"status":"interpretation","text":"Jos järjestelmä ei aidosti mahdollista koko työn hylkäämistä, ihminen on käyttöliittymäelementti, ei päätöksentekijä.","evidence":[],"note":"Tulkinta; ei ulkoista lähdettä."},{"status":"interpretation","text":"Ajosta voi muodostaa metatietokuitin ja hajautusjäljen eli tiivisteen, jonka avulla ajon kuvauksen voi varmistaa muuttumattomaksi ilman koko sisällön paljastamista.","evidence":[],"note":"Oma järjestelmäkuvaus; ei riippumatonta lähdettä."},{"status":"interpretation","text":"Läpinäkyvyys ei tarkoita raakadatan kaatamista käyttäjän silmille, vaan olennaisten päätösten, rajojen, lähteiden ja muutosten näkymistä.","evidence":[],"note":"Määritelmällinen tulkinta."},{"status":"interpretation","text":"Valmiin tekstin tekoälytunnistus on arvaus, ei tarkastus; olennaiset vaiheet voi tarkastaa silloin, kun ne tapahtuvat.","evidence":[],"note":"Johtopäätös, joka nojaa candidate-lähteeseen."},{"status":"interpretation","text":"Agenttien sitominen sopimuksiin estää mustan laatikon syntymisen vanhan mustan laatikon ympärille.","evidence":[],"note":"Kirjoittajan tulkinta; ei empiiristä vahvistusta."},{"status":"interpretation","text":"Kun koneelle rakentaa tarpeeksi tiukat seinät, niiden sisällä voi tehdä oudompia asioita turvallisesti.","evidence":[],"note":"Mielipide/visio."},{"status":"interpretation","text":"Suomenkielinen käyttöliittymä täyttyy helposti sanoista kuten orkestrointi, provenienssi ja evidenssin tila; liiallinen termistö heikentää ymmärrystä.","evidence":[],"note":"Tulkinnallinen havainto."},{"status":"interpretation","text":"Tekoälyn käytön ei tarvitse olla salaisuus; tärkeintä on tietää, mitä tekoäly teki, mihin se perustui ja kuka vastasi tuloksesta.","evidence":[],"note":"Arvoihin perustuva suositus."},{"status":"interpretation","text":"Tulevaisuus ei välttämättä tarvitse autonomisempaa tekoälyä, vaan selkeämpiä rajoja, sopimuksia ja näkyvämpiä prosesseja.","evidence":[],"note":"Kirjoittajan eksplisiittinen mielipide."}]
citationMode: "inline"
citationPlacements: []
visualizations: []
pinned: false
...
# En rakentanut agentteja ajattelemaan puolestani

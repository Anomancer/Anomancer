...
echo "ANOMANCER 1.22.0 · LIGHTHOUSE ACTUATOR · CONTENT-SAFE INSTALL"
...
npm install
npm run build
ANOMANCER_EXPORT_INCLUDE_UNTRACKED=1 npm run check
...
echo "✓ Anomancer 1.22.0 Lighthouse Actuator asennettu, rakennettu ja tarkistettu."

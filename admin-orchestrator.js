...
${baseInstruction}`);
  ...
  window.addEventListener('anomancer:core-ready',event=>{const core=event.detail||{};AGENTS=(core.agents||AGENT_FALLBACK).map(a=>({id:a.id,label:a.label,role:a.role}));log(`Core ${core.version||'16.0'} · Mukautettujen orkestereiden tuki valmis`,'◈');});
